...
namespace Tabletop.Online
{
    ...
    public abstract class OnlineDragObject : OnlineOutLineObj
    {
        ...
        public OnlineContainerObj Container;
        ...
        public void CmdMouseDown(uint playerNid)
        {
            ...
            {
                OnlinePlayerManager.Instance.SendMsg(playerNid, "你不能使用对方的棋子");
                return;
            }
            MouseDown(OnlinePlayerManager.Instance.GetConn(playerNid));
        }
        ...
        public void CmdMouseUp(uint playerNid, Ray ray)
        {
            ...
            MouseUp(OnlinePlayerManager.Instance.GetConn(playerNid), playerNid, ray);
        }
        ...
        public void MouseUp(NetworkConnectionToClient conn, uint playerNid, Ray ray)
        {
            ...
            OnlineIAttachable attachObj = RaycastContanier(ray);
            if (attachObj != null)
            {
        ...
        [Server]
        protected OnlineIAttachable RaycastContanier(Ray ray)
        {
            ...
            foreach (RaycastHit hit in hits)
            {
                ...
                OnlineIAttachable attachObj = null;
